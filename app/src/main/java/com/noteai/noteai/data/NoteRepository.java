...
public class NoteRepository implements NoteDataSource {
    ...
    private final SqliteNoteDataSource sqlite;
    ...
    public NoteRepository(Context context) {
        ...
        this.sqlite = new SqliteNoteDataSource(context.getApplicationContext());
    ...
    public void setNoteCategory(long noteId, Long categoryId) {
        ...
        sqlite.setNoteCategory(noteId, categoryId);
    ...
    public List<Category> getAllCategories() {
        ...
        return sqlite.getAllCategories();
    }
    ...
    public List<Note> getNotesByCategory(long categoryId) {
        List<Note> fromSqlite = sqlite.getNotesByCategory(categoryId);
    ...
    public List<Tag> getTagsForNote(long noteId) {
        ...
        // return new ArrayList<>();
        return sqlite.getTagsForNote(noteId);
    }
    ...
    public List<Note> getNotesByTag(long tagId) {
        ...
        // return new ArrayList<>();
        List<Note> fromSqlite = sqlite.getNotesByTag(tagId);
        if (!fromSqlite.isEmpty()) {
            return fromSqlite;
        }
        List<Note> result = new ArrayList<>();
        for (Note note : store) {
            for (Tag tag : sqlite.getTagsForNote(note.id)) {
                if (tag.id == tagId) {
                    result.add(note);
                    break;
                }
